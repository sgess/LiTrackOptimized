...
PARAM.INIT.NPART = 1.90E10; % Number of electrons per bunch
...
PARAM.NRTL.AMPL  = 0.0406;  % RTL compressor ampl (MV)
...
l_two = 0;
PARAM.LTWO.PHAS  = l_two+ramp;    % 11-20 phase
...
PARAM.LI20.T566  = 0.167;   % Sector 20 chicane T566 (m) % = 100 mm for R56 = 5mm from YS
