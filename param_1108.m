...
PARAM.INIT.SIGZ0 = 6.30E-3; % RMS bunch length (m)
PARAM.INIT.SIGD0 = 7.07E-4; % RMS energy spread
PARAM.INIT.Z0BAR = 0;       % Z offset
PARAM.INIT.D0BAR = 0;       % Energy offset
PARAM.INIT.NESIM = 2E5;     % Number of simulated macro particles
PARAM.INIT.NPART = 2.09E10; % Number of electrons per bunch
PARAM.INIT.ASYM  = -0.124;  % The Holtzapple skew
PARAM.INIT.TAIL  = 0;       % Not sure what this is
PARAM.INIT.CUT   = 6;       % Not sure what this is

% NRTL bunch compressor
PARAM.NRTL.AMPL  = 0.0356;  % RTL compressor ampl (MV)
PARAM.NRTL.PHAS  = 87.00;   % RTL compressor phase (deg)
PARAM.NRTL.LEFF  = 2.1694;  % RTL cavity length (m)
PARAM.NRTL.R56   = 0.5445;  % RTL chicane R56 (m)
PARAM.NRTL.T566  = 0.930;   % RTL chicane T566 (m)
...
decker           = -19.55;  % Chirping phase
ramp             = +0.58;   % Ramped phase
...
PARAM.LI20.R16   = 124;     % Dispersion at YAG
PARAM.LI20.T166  = -45;     % Second order dispersion at YAG
PARAM.LI20.BETA  = 5.2;     % Beta function at YAG
