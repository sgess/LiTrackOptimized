...
PARAM.INIT.SIGZ0 = 9.00E-3; % RMS bunch length (m)
PARAM.INIT.SIGD0 = 6.00E-4; % RMS energy spread
...
PARAM.NRTL.AMPL  = 0.033;   % RTL compressor ampl (MV)
PARAM.NRTL.PHAS  = 88.80;   % RTL compressor phase (deg)
...
decker           = -17.4;   % Chirping phase
ramp             = +0.70;   % Ramped phase
