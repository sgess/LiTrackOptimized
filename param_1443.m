...
PARAM.INIT.SIGZ0 = 6.20E-3; % RMS bunch length (m)
PARAM.INIT.SIGD0 = 5.00E-4; % RMS energy spread
...
PARAM.NRTL.AMPL  = 0.0401;  % RTL compressor ampl (MV)
PARAM.NRTL.PHAS  = 90.00;   % RTL compressor phase (deg)
PARAM.NRTL.LEFF  = 2.1694;  % RTL cavity length (m)
PARAM.NRTL.R56   = 0.5245;  % RTL chicane R56 (m)
PARAM.NRTL.T566  = 1.390;   % RTL chicane T566 (m)
...
decker           = -23.92;  % Chirping phase
ramp             = +3.17;   % Ramped phase
...
PARAM.LI20.R16   = 119;     % Dispersion at YAG
PARAM.LI20.T166  = -200;    % Second order dispersion at YAG
PARAM.LI20.BETA  = 4.7;     % Beta function at YAG
